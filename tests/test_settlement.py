...
def test_settlement_all_shared_50_50(mocker, env_setup):
    ...
    mocker.patch(
        "lib.settlement.get_transactions_for_statement_period",
        return_value=[make_transaction(100.00, "S"), make_transaction(50.00, "S")],
    )
...
def test_settlement_unclassified_count(mocker, env_setup):
    ...
    mocker.patch(
        "lib.settlement.get_transactions_for_statement_period",
        return_value=[make_transaction(100.00, ""), make_transaction(50.00, "S")],
    )
