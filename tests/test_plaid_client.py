...
SAMPLE_PLAID_TRANSACTIONS = [
    {"transaction_id": "tx1", "date": "2026-01-29", "amount": 50.00, "name": "Target", "merchant_name": "Target"},
    {
        "transaction_id": "tx2",
        "date": "2026-01-28",
        "amount": -10.00,  # Credit
...
def test_fetch_new_transactions_retry_logic(mocker, env_setup):
    ...
    mock_client.transactions_sync.side_effect = [ApiException("error"), ApiException("error"), mock_response]
